...
import { useRegister } from "@/services/api-client-react";
      ...
      <div className="flex-1 flex flex-col justify-center items-center z-10 px-4">
        ...
        >
          ...
          <div className="bg-card rounded-2xl border border-border/50 shadow-xl shadow-black/5 p-8 relative overflow-hidden">
            ...
            <div className="mb-8">
              <h1 className="text-2xl font-bold tracking-tight text-foreground mb-2">Criar conta</h1>
              <p className="text-sm text-muted-foreground">Comece a gerenciar seus webhooks hoje.</p>
            </div>
